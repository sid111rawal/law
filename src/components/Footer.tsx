        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-gold p-3 rounded-full hover:bg-opacity-90 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#services" className="text-gray-100 hover:text-gold transition-colors">
                  Our Services
                </Link>
              </li>
              <li>
                <Link href="#about" className="text-gray-100 hover:text-gold transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="#contact" className="text-gray-100 hover:text-gold transition-colors">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="#consultation" className="text-gray-100 hover:text-gold transition-colors">
                  Book Consultation
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-100 hover:text-gold transition-colors">
                  Business Accounting
                </a>
              </li>
              <li>
