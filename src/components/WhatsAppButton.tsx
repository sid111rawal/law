  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      ...
      {(isHovered || showTooltip) && (
        <div className="absolute bottom-full right-0 mb-2 animate-fade-in-up">
          <div className="bg-white rounded-lg shadow-xl border border-gray-200 p-3 whitespace-nowrap">
            <p className="text-sm font-semibold text-slate mb-1">Chat with us on WhatsApp</p>
            <p className="text-xs text-gray-600">{siteConfig.contact.whatsappDisplay}</p>
      ...
      <button
        ...
        className="bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-110 active:scale-95 flex items-center justify-center group-hover:rounded-2xl"
